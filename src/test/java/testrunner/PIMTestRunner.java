...
public class PIMTestRunner extends Setup {
    ...
    @Test(priority = 1, groups = "smoke", description = "Admin can create new user")
...
//        String employeeId = faker.idNumber().valid().
        ...
        Utils.saveUsers(employeeModel);  //save credentials to Json array file at resources folder
    }
}
